...
import { HistoricoComponent } from './components/modulos/archivos/historico/historico.component';
...
const appRoutes: Routes = [
    ...
    { path: 'convencion', component: ConvencionComponent, canActivate: [AuthGuard] },
    { path: 'historico/:archivoid', component: HistoricoComponent, canActivate: [AuthGuard] },
